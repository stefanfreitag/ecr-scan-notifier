...
| <code><a href="#ecr-scan-notifier.EcrScanNotifier.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="ecr-scan-notifier.EcrScanNotifier.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="ecr-scan-notifier.EcrScanNotifier.with.parameter.mixins"></a>
